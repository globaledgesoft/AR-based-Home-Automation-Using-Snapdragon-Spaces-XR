...
namespace QCHT.Samples.Drawing
{
    ...
    public abstract class Pen : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("clayHandLeftFeedback")]
        [CanBeEmpty]
        [SerializeField] protected QCHTHandVisualFeedback ClayQCHTHandLeftFeedback;

        [FormerlySerializedAs("clayHandRightFeedback")]
        [CanBeEmpty]
        [SerializeField] protected QCHTHandVisualFeedback ClayQCHTHandRightFeedback;
        ...
        {
            var clayHandFeedback = isLeft ? ClayQCHTHandLeftFeedback : ClayQCHTHandRightFeedback;
        ...
        private void UpdatePencil(bool isLeft, PencilPointer pencilPointer, ref bool isDrawing)
        {
            ...
            var isTracked = isLeft ? XRHandTrackingManager.LeftHand.IsTracked : XRHandTrackingManager.RightHand.IsTracked;
        ...
        {
            var hand = isLeft ? XRHandTrackingManager.LeftHand : XRHandTrackingManager.RightHand;
